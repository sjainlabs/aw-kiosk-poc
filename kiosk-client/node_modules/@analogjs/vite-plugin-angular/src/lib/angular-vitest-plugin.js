 ...
 */
export function angularVitestSourcemapPlugin(getInMap) {
    return {
...
export function angularVitestPlugins(getInMap) {
    return [
        angularVitestPlugin(),
