 ...
 */
export function encapsulateComponentStylesPlugin() {
    return {
...
export function isComponentStyleSheet(id) {
 ...
 */
export function getFilenameFromPath(id) {
    return new URL(id, 'http://localhost').pathname.replace(/^\//, '');
}
export function getComponentStyleSheetMeta(id) {
    const queryIndex = id.indexOf('?');
    const params = new URLSearchParams(queryIndex === -1 ? '' : id.slice(queryIndex + 1));
    const encapsulationMapping = {
        '0': 'emulated',
        '2': 'none',
        '3': 'shadow',
    };
    const encapsulationKey = params.get('e');
    return {
 ...
 */
export function encapsulateViteCssOutput(code, componentId) {
...
//# sourceMappingURL=encapsulate-component-styles-plugin.js.map