...
export function extractConstructorDeps(classNode, sourceCode, typeOnlyImports) {
    ...
    const members = classNode.body?.body || [];
    const ctors = members.filter((m) => m.type === 'MethodDefinition' && m.kind === 'constructor');
