 ...
 */
export function resolveSyntheticImportSpecifier(currentFileName, entry, fallbackSpecifier) {
    if (entry.sourcePackage)
        return entry.sourcePackage;
 ...
 */
export function deriveRelativeImportPath(fromFile, toFile) {
